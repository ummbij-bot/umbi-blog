    ...
    <>
      ...
      <article className="min-h-screen bg-[#fefdfb]">
        <div className="bg-white border-b border-stone-200">
          <div className="container-custom py-3">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/finance" className="text-stone-400 hover:text-stone-700 transition-colors">Finance</Link>
              <span className="text-stone-300">/</span>
        ...
        <div className="relative w-full aspect-[2/1] max-h-[420px] bg-stone-900">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/70 via-black/20 to-transparent" />
            ...
            <div className="prose prose-lg max-w-none prose-headings:scroll-mt-20">
              <ReactMarkdown
                components={{
                  ...
                  blockquote: (props) => <blockquote className="border-l-4 border-emerald-500 pl-4 my-6 text-stone-600 italic" {...props} />,
