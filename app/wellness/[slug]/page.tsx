        ...
        <div className="bg-white border-b border-stone-200">
          <div className="container-custom py-3">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/wellness" className="text-stone-400 hover:text-stone-700 transition-colors">Wellness</Link>
              <span className="text-stone-300">/</span>
            ...
            <div className="prose prose-lg max-w-none prose-headings:scroll-mt-20">
              <ReactMarkdown
                components={{
                  ...
                  blockquote: (props) => <blockquote className="border-l-4 border-purple-500 pl-4 my-6 text-stone-600 italic" {...props} />,
