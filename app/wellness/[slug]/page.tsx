        ...
        <div className="bg-white border-b border-neutral-200">
          <div className="container-custom py-4">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/wellness" className="text-neutral-500 hover:text-neutral-900 transition-colors">Wellness</Link>
              <span className="text-neutral-300">/</span>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
            <div className="container-custom">
              <div className="max-w-3xl">
                <span className="inline-block px-3 py-1 rounded-lg text-xs font-bold bg-purple-500 text-white mb-4">
                  Wellness
                </span>
        ...
        <div className="container-custom py-10">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8 pb-6 border-b border-neutral-200">
              ...
              <ShareButtons title={post.title} slug={post.slug} category="wellness" />
            </div>
            ...
            <div className="prose prose-lg max-w-none prose-headings:scroll-mt-20">
              <ReactMarkdown
                components={{
                  ...
                  blockquote: (props) => <blockquote className="border-l-4 border-purple-500 pl-4 my-6 text-neutral-600 italic" {...props} />,
